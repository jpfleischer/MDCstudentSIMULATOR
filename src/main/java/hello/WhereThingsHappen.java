...
public class WhereThingsHappen extends javax.swing.JFrame {
    ...
    public WhereThingsHappen() {
        ...
        if (theretrieved == 0) {
            charactermiddle.setIcon(new ImageIcon(getClass().getResource("/bluedude.png")));
        }
        if (theretrieved == 1) {
            charactermiddle.setIcon(new ImageIcon(getClass().getResource("/pinkdude.png")));
        }
        if (theretrieved == 2) {
            charactermiddle.setIcon(new ImageIcon(getClass().getResource("/yellowdude.png")));
        }
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {
        ...
        // Load the image from the classpath using getResource()
        ImageIcon icon = new ImageIcon(getClass().getResource("/finnlogo.png"));
        ...
        JOptionPane.showMessageDialog(null,
                ...
                "That's the breaks!", JOptionPane.PLAIN_MESSAGE, new ImageIcon(image2));
    }
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {// GEN-FIRST:event_formWindowGainedFocus
        ...
        if (thegrades >= 90) {
            gradeicon.setIcon(new ImageIcon(getClass().getResource("/gradeA.png")));
        }
        if ((thegrades >= 80) && (thegrades < 90)) {
            gradeicon.setIcon(new ImageIcon(getClass().getResource("/gradeB.png")));
        }
        if ((thegrades >= 70) && (thegrades < 80)) {
            gradeicon.setIcon(new ImageIcon(getClass().getResource("/gradeC.png")));
        }
        if ((thegrades >= 60) && (thegrades < 70)) {
            gradeicon.setIcon(new ImageIcon(getClass().getResource("/gradeD.png")));
        }
        if (thegrades < 60) {
            gradeicon.setIcon(new ImageIcon(getClass().getResource("/gradeF.png")));
        }
        if ((thegrades + thehappy) <= 80) {
            playermusic z = playermusic.getInstance();
            if (z.getPlayingNow().equals("/sad.mp3")) {
            } else {
                z.Stop();
                z.Play("/sad.mp3");
            }
            if (theretrieved == 0) {
                charactermiddle.setIcon(new ImageIcon(getClass().getResource("/bluedudesad.png")));
            }
            if (theretrieved == 1) {
                charactermiddle.setIcon(new ImageIcon(getClass().getResource("/pinkdudesad.png")));
            }
            if (theretrieved == 2) {
                charactermiddle.setIcon(new ImageIcon(getClass().getResource("/yellowdudesad.png")));
            }
        }
        if (((thegrades + thehappy) < 120) && ((thegrades + thehappy) > 80)) {
            playermusic z = playermusic.getInstance();
            if (z.getPlayingNow().equals("/mid.mp3")) {
            } else {
                z.Stop();
                z.Play("/mid.mp3");
            }
        ...
        if (((thegrades + thehappy) < 145) && ((thegrades + thehappy) >= 120) && (howmanytimeswindowfocused > 2)) {
            playermusic z = playermusic.getInstance();
            if (z.getPlayingNow().equals("/alright.mp3")) {
            } else {
                z.Stop();
                z.Play("/alright.mp3");
            }
        ...
        if ((thegrades + thehappy) >= 145) {
            playermusic z = playermusic.getInstance();
            if (z.getPlayingNow().equals("/cool.mp3")) {
            } else {
                z.Stop();
                z.Play("/cool.mp3");
            }
        ...
        if (thehappy <= 0) {
            ...
            // Display the message with the image
            JOptionPane.showMessageDialog(null,
                    "Oh no! You fell into a depressive state and dropped out.\nDo not forget to take care of your mental health next time.",
                    "Happiness Too Low", JOptionPane.PLAIN_MESSAGE, new ImageIcon(image2));
        ...
        if (thehappy >= 75) {
            if (theretrieved == 0) {
                charactermiddle.setIcon(new ImageIcon(getClass().getResource("/blueduderad.png")));
            }
            if (theretrieved == 1) {
                charactermiddle.setIcon(new ImageIcon(getClass().getResource("/pinkduderad.png")));
            }
            if (theretrieved == 2) {
                charactermiddle.setIcon(new ImageIcon(getClass().getResource("/yellowduderad.png")));
            }
        }
        if (day == 13) {
            playermusic z = playermusic.getInstance();
            ...
            // Show the end of semester message with the image
            JOptionPane.showMessageDialog(null, "The semester is over! Let's see how you did.", "Results",
                    JOptionPane.PLAIN_MESSAGE, new ImageIcon(image2));

            if ((thehappy > 0) && (thegrades > 69)) {
                // Play the victory music
                z.Play("/victory.mp3"); // Ensure this path is correct for the audio resource
                dispose();
                WinningScreen.main();
            } else {
                dispose();
                // Show failure message with the image
                JOptionPane.showMessageDialog(null, "Your subpar grades led you to fail your classes.", "Results",
                        JOptionPane.PLAIN_MESSAGE, new ImageIcon(image2));
                LosingScreen.main();
            }
        }
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WhereThingsHappen.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
