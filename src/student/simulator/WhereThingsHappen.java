...
private static class RoundedBorder implements Border {
    ...
    public WhereThingsHappen() {
        ...
        if (theretrieved == 0){
        try {
                charactermiddle.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/bluedude.png"))));
        ...
        if (theretrieved == 1){
        try {
                charactermiddle.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/pinkdude.png"))));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
        if (theretrieved == 2){
        try {
                charactermiddle.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/yellowdude.png"))));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
    ...
    private void initComponents() {
        ...
        gradeicon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/gradeB.png"))); // NOI18N
        ...
        calendar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/calendar.png"))); // NOI18N
        ...
        vidyaButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/vidyagame.png"))); // NOI18N
        ...
        studyButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/study.png"))); // NOI18N
        ...
        partayButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/partay.png"))); // NOI18N
        ...
        lectureButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/lecture.png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/dorm.jpg"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        final ImageIcon icon = new ImageIcon("src/resources/finnlogo.png");
        Image image2 = icon.getImage().getScaledInstance(130,100,0);
        JOptionPane.showMessageDialog(null, """
                                            You have 12 days to maintain your grades and your happiness.
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        if(thegrades >= 90){
            try {
                gradeicon.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/gradeA.png"))));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
        if((thegrades>=80)&&(thegrades<90)){
            try {
                gradeicon.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/gradeB.png"))));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
        if((thegrades>=70)&&(thegrades<80)){
            try {
                gradeicon.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/gradeC.png"))));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
        if((thegrades>=60)&&(thegrades<70)){
            try {
                gradeicon.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/gradeD.png"))));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
        if(thegrades<60){
            try {
                gradeicon.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/gradeF.png"))));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
        if((thegrades+thehappy)<=80){
            ...
            if(z.getPlayingNow().equals("src/resources/sad.mp3")){
            } else{
            z.Stop();
            z.Play("src/resources/sad.mp3");
            }
            if(theretrieved==0){
                try { 
                    charactermiddle.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/bluedudesad.png"))));
                } catch (IOException ex) {
                    ex.printStackTrace();
                }
            }
            if(theretrieved==1){
                try { 
                    charactermiddle.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/pinkdudesad.png"))));
                } catch (IOException ex) {
                    ex.printStackTrace();
                }
            }
            if(theretrieved==2){
                try { 
                    charactermiddle.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/yellowdudesad.png"))));
                } catch (IOException ex) {
                    ex.printStackTrace();
                }
            }
        ...
        if(((thegrades+thehappy)<120)&&((thegrades+thehappy)>80)){
            playermusic z = playermusic.getInstance();
            if(z.getPlayingNow().equals("src/resources/mid.mp3")){
            } else{
            z.Stop();
            z.Play("src/resources/mid.mp3");
            }
        }
        if(((thegrades+thehappy)<145)&&((thegrades+thehappy)>=120)&&(howmanytimeswindowfocused>2)){
            playermusic z = playermusic.getInstance();
            if(z.getPlayingNow().equals("src/resources/alright.mp3")){
            } else{
            z.Stop();
            z.Play("src/resources/alright.mp3");
            }
            }
        if((thegrades+thehappy)>=145){
            playermusic z = playermusic.getInstance();
            if(z.getPlayingNow().equals("src/resources/cool.mp3")){
            } else{
            z.Stop();
            z.Play("src/resources/cool.mp3");
            }
            }
        if(thehappy<=0){
            ...
            Image image2 = icon.getImage().getScaledInstance(130,100,0);
            JOptionPane.showMessageDialog(null, """
                                            Oh no! You fell into a depressive state and dropped out.\n
        ...
        if(thehappy>=75){
            if(theretrieved==0){
                try { 
                    charactermiddle.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/blueduderad.png"))));
                } catch (IOException ex) {
                    ex.printStackTrace();
                }
            }
            if(theretrieved==1){
                try { 
                    charactermiddle.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/pinkduderad.png"))));
                } catch (IOException ex) {
                    ex.printStackTrace();
                }
            }
            if(theretrieved==2){
                try { 
                    charactermiddle.setIcon(new ImageIcon(ImageIO.read(new File("src/resources/yellowduderad.png"))));
                } catch (IOException ex) {
                    ex.printStackTrace();
                }
            }
        ...
        if(day==13){
            ...
            Image image2 = icon.getImage().getScaledInstance(130,100,0);
            JOptionPane.showMessageDialog(null, """
                                            The semester is over! Let's see how you did.""", "Results", JOptionPane.PLAIN_MESSAGE, new ImageIcon(image2));
            if((thehappy>0)&&(thegrades>69)){
                z.Play("src/resources/victory.mp3");
                dispose();
                WinningScreen.main();
            } else{
                dispose();
                JOptionPane.showMessageDialog(null, """
                Your subpar grades led you to fail your classes.""", "Results", JOptionPane.PLAIN_MESSAGE, new ImageIcon(image2));
                LosingScreen.main();
            }
        }
