...
public class Study extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/studyscreen.jpg"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        if((randomInt>10)&&(randomInt<90)){
            final ImageIcon icon = new ImageIcon("src/resources/study.png");
        ...
        if((randomInt<=10)){
            final ImageIcon icon = new ImageIcon("src/resources/ripstudy.png");
            Image image2 = icon.getImage().getScaledInstance(130,100,0);
            JOptionPane.showMessageDialog(null, """
        ...
        if((randomInt>=90)){
            final ImageIcon icon = new ImageIcon("src/resources/awesomestudy.png");
            Image image2 = icon.getImage().getScaledInstance(130,100,0);
            JOptionPane.showMessageDialog(null, """
